...
<head>
	...
	<body class="app flex-row align-items-center" style="background: url('${contextPath}/images/user/main/cm1.jpg') no-repeat; background-size: 100%;">
