...
public class EgovLoginController {
	...
	public String loginUsrView(@ModelAttribute("loginVO") LoginVO loginVO, HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		try{
		    ...
		    return "egovframework/example/egovframework/com/cmm/egovError";
		}
		*/
		return "egovframework/example/egovframework/com/uat/uia/EgovLoginUsr";
	}
	...
	public String idPasswordSearchView(ModelMap model) throws Exception {
		...
		return "egovframework/example/egovframework/com/uat/uia/EgovIdPasswordSearch";
	}
	...
	public String gpkiIssuView(ModelMap model) throws Exception {
		return "egovframework/example/egovframework/com/uat/uia/EgovGpkiIssu";
	}
	...
	public String searchId(@ModelAttribute("loginVO") LoginVO loginVO, ModelMap model) throws Exception {
		...
		if (resultVO != null && resultVO.getId() != null && !resultVO.getId().equals("")) {
			...
			return "egovframework/example/egovframework/com/uat/uia/EgovIdPasswordResult";
		} else {
	...
	public String gpkiRegistView(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		try {
		    ...
		    return "egovframework/example/egovframework/com/uat/uia/EgovGpkiRegist";
