...
public class EgovLoginPolicyController {
	...
	public String selectLoginPolicyListView() throws Exception {
		return "egovframework/example/egovframework/com/uat/uap/EgovLoginPolicyList";
	}	
	...
	public String selectLoginPolicy(@RequestParam("emplyrId") String emplyrId, 
		...
		if(vo.getRegYn().equals("N")) 
			return "egovframework/example/egovframework/com/uat/uap/EgovLoginPolicyRegist";
		else 
			return "egovframework/example/egovframework/com/uat/uap/EgovLoginPolicyUpdt";
	}
