...
public class EgovDiaryManageController {
	 ...
	 * @param commandMap
	 * @param model
	 * @return "egovframework/example/egovframework/com/cop/smt/dsm/EgovDiaryManageDetail"
	 * @throws Exception
	 */
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "egovframework/example/egovframework/com/cop/smt/dsm/EgovDiaryManageModify"
	 * @throws Exception
	 */
	@SuppressWarnings("unused")
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "egovframework/example/egovframework/com/cop/smt/dsm/EgovDiaryManageModifyActor"
	 * @throws Exception
	 */
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "egovframework/example/egovframework/com/cop/smt/dsm/DiaryManageRegistActor"
	 * @throws Exception
	 */
