...
public class EgovAllSchdulManageController {
	 ...
	 * @param commandMap
	 * @param model
	 * @return "egovframework/example/egovframework/com/uss/olp/qrm/EgovAllSchdulManageList"
	 * @throws Exception
	 */
    ...
    throws Exception {
		...
		return "egovframework/example/egovframework/com/cop/smt/sam/EgovAllSchdulManageList";
	}
