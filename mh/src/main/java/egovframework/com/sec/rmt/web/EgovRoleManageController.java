...
public class EgovRoleManageController {
    ...
    public String selectRoleListView()
            throws Exception {
        return "egovframework/example/egovframework/com/sec/rmt/EgovRoleManage";
    }
	...
	public String selectRole(@RequestParam("roleCode") String roleCode,
        ...
        return "egovframework/example/egovframework/com/sec/rmt/EgovRoleUpdate";
	}
    ...
    public String insertRoleView(@ModelAttribute("authorManageVO") AuthorManageVO authorManageVO,
        ...
        return "egovframework/example/egovframework/com/sec/rmt/EgovRoleInsert";
    }
