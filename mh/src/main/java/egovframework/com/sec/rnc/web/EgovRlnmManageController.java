...
//			return "egovframework/example/egovframework/com/sec/rnc/EgovRlnmCnfirm";
//		}
//
//		try {
...
//		return "egovframework/example/egovframework/com/sec/rnc/EgovRlnmCnfirm";
	...
	public String rlnmPinCnfirm(Model model, @RequestParam Map<String, Object> commandMap, HttpServletRequest request) throws Exception {
		...
		return "egovframework/example/egovframework/com/sec/rnc/EgovRlnmPinCnfirm";
	}
	...
	public String gpinCall(Model model, @RequestParam Map<String, Object> commandMap) throws Exception {
		...
		return "egovframework/example/egovframework/com/sec/rnc/gpin/Sample-AuthRequest";
	}
	...
	public String validate() {
		return "egovframework/example/egovframework/com/cmm/validator";
	}
