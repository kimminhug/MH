...
public class EgovAuthorManageController {
    ...
    public String selectAuthorListView()
            throws Exception {
        return "egovframework/example/egovframework/com/sec/ram/EgovAuthorManage";
    }    
    ...
    public String selectAuthor(@RequestParam("authorCode") String authorCode,
    	...
    	model.addAttribute("message", egovMessageSource.getMessage("success.common.select"));
    	return "egovframework/example/egovframework/com/sec/ram/EgovAuthorUpdate";
    }     
    ...
    public String insertAuthorView()
            throws Exception {
        return "egovframework/example/egovframework/com/sec/ram/EgovAuthorInsert";
    }
    ...
    public String accessDenied()
            throws Exception {
        return "egovframework/example/egovframework/com/sec/accessDenied";
    } 
}
