...
public class EgovGroupManageController {
    ...
    public String selectGroupListView()
            throws Exception {
        return "egovframework/example/egovframework/com/sec/gmt/EgovGroupManage";
    }   
	...
	public String selectGroup(@ModelAttribute("groupManageVO") GroupManageVO groupManageVO, 
	    ...
	    return "egovframework/example/egovframework/com/sec/gmt/EgovGroupUpdate";
	}
    ...
    public String insertGroupView()
            throws Exception {
        return "egovframework/example/egovframework/com/sec/gmt/EgovGroupInsert";
    }
    ...
    public String selectGroupSearchView()
            throws Exception {
        return "egovframework/example/egovframework/com/sec/gmt/EgovGroupSearch";
    }   
