...
public class EgovComIndexController implements ApplicationContextAware, InitializingBean {
	...
	public String index(ModelMap model) {
		return "egovframework/example/egovframework/com/cmm/EgovUnitMain";
	}

	@RequestMapping("/EgovTop.do")
	public String top() {
		return "egovframework/example/egovframework/com/cmm/EgovUnitTop";
	}

	@RequestMapping("/EgovBottom.do")
	public String bottom() {
		return "egovframework/example/egovframework/com/cmm/EgovUnitBottom";
	}
	...
	public String setContent(ModelMap model) {
		...
		return "egovframework/example/egovframework/com/cmm/EgovUnitContent";
	}
	...
	public String setLeftMenu(ModelMap model) {
		...
		return "egovframework/example/egovframework/com/cmm/EgovUnitLeft";
	}
}
