...
public class EgovMainMenuManageController {
    ...
    public String selectMainMenuIndex(
        ...
        return "egovframework/example/egovframework/com/menu_index";
    }
    ...
    public String selectMainMenu(
		...
		if (!user.getId().equals("")) {
			...
			if (user.getUserSe().equals("USR")) {
	    		return "egovframework/example/egovframework/com/EgovMainView";
	    	} else {
	    		return "egovframework/example/egovframework/com/EgovMainViewG";
        	}
        } else {
        	// 오류 페이지 이동
        	return "egovframework/example/egovframework/com/cmm/error/egovError";
        }
    }
    ...
    public String selectMainMenuHead(
		...
		if (!user.getId().equals("")) {
			...
			// G일반 / E기업 / U업무
			if (user.getUserSe().equals("USR")) {
        		return "egovframework/example/egovframework/com/main_head"; //"EgovMainViewG"; 일반사용자
        	} else {
        		return "egovframework/example/egovframework/com/main_headG";
        	}
        } else {
        	// 오류 페이지 이동
        	return "egovframework/example/egovframework/com/cmm/error/egovError";
    ...
    public String selectMainMenuLeft(
        ...
        model.addAttribute("list_menulist", list_menulist);
      	return "egovframework/example/egovframework/com/main_left";
    }
    ...
    public String selectMainMenuHome(
		...
		if (!user.getId().equals("")) {
        	...
        	if (user.getUserSe().equals("GNR")) {//2011.09.07
        		return "egovframework/example/egovframework/com/EgovMainViewG"; //"EgovMainViewG"; 일반사용자

        	}else if(user.getUserSe().equals("USR")){//2011.09.07
        		//return "egovframework/example/egovframework/com/EgovIndvdlpgeDetail";
        		return "egovframework/example/egovframework/com/EgovMainView";
        	}
        	else {
        		//return "egovframework/example/egovframework/com/EgovMainView";//1차 사업 메인화면
        		return "egovframework/example/egovframework/com/EgovMainView2";//2차 사업 메인화면
        	}
        } else {
        	// 오류 페이지 이동
        	return "egovframework/example/egovframework/com/cmm/error/egovError";
