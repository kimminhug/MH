...
public class EgovCcmCmmnDetailCodeManageController {
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "egovframework/example/egovframework/com/sym/ccm/cde/EgovCcmCmmnDetailCodeRegist"
	 * @throws Exception
	 */
	 ...
	 * @param cmmnDetailCode
	 * @param model
	 * @return "egovframework/example/egovframework/com/cmm/sym/ccm/EgovCcmCmmnDetailCodeDetail"
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/ccm/cde/EgovCcmCmmnDetailCodeDetail.do")
 	public String selectCmmnDetailCodeDetail (@ModelAttribute("loginVO") LoginVO loginVO
		...
		return "egovframework/example/egovframework/com/sym/ccm/cde/EgovCcmCmmnDetailCodeDetail";
	}
     ...
     * @param searchVO
     * @param model
     * @return "egovframework/example/egovframework/com/sym/ccm/cde/EgovCcmCmmnDetailCodeList"
     * @throws Exception
     */
	 ...
	 * @param commandMap
	 * @param model
	 * @return "egovframework/example/egovframework/com/sym/ccm/cde/EgovCcmCmmnDetailCodeModify"
	 * @throws Exception
	 */
