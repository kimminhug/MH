...
public class EgovInsttCodeRecptnController {
	 ...
	 * @param commandMap
	 * @param model
	 * @return "egovframework/example/egovframework/com/sym/ccm/icr/EgovInsttCodeRegist_TEST"
	...
	@RequestMapping(value="/sym/ccm/icr/getInsttCodeDetail.do")
 	public String selectInsttCodeDetail (@ModelAttribute("insttCode") InsttCodeRecptn insttCode
		...
		return "egovframework/example/egovframework/com/sym/ccm/icr/EgovInsttCodeDetail";
	}
     ...
     * @param searchVO
     * @param model
     * @return "egovframework/example/egovframework/com/sym/ccm/icr/EgovInsttCodeRecptnList"
     * @throws Exception
     */
     ...
     * @param searchVO
     * @param model
     * @return "egovframework/example/egovframework/com/cmm/sym/ccm/EgovCcmInsttCodeList"
     * @throws Exception
     */
	...
	public String selectInsttCodeRecptnMainList (@ModelAttribute("searchVO") InsttCodeRecptnVO searchVO
        ...
        return "egovframework/example/egovframework/com/sym/ccm/icr/EgovInsttCodeRecptnMainList";
	}
