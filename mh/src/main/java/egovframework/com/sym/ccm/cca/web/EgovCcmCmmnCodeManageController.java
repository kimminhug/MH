...
public class EgovCcmCmmnCodeManageController {
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "egovframework/example/egovframework/com/sym/ccm/cca/EgovCcmCmmnCodeRegist"
	 * @throws Exception
	 */
	 ...
	 * @param cmmnCode
	 * @param model
	 * @return "egovframework/example/egovframework/com/sym/ccm/cca/EgovCcmCmmnCodeDetail"
	 * @throws Exception
	 */
     ...
     * @param searchVO
     * @param model
     * @return "egovframework/example/egovframework/com/sym/ccm/cca/EgovCcmCmmnCodeList"
     * @throws Exception
     */
	 ...
	 * @param commandMap
	 * @param model
	 * @return "egovframework/example/egovframework/com/sym/ccm/cca/EgovCcmCmmnCodeModify"
	 * @throws Exception
	 */
