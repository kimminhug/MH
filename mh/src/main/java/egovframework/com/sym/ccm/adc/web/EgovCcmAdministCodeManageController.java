...
public class EgovCcmAdministCodeManageController {
	 ...
	 * 일반달력 팝업 메인창을 호출한다.
	 * @param model
	 * @return "egovframework/example/egovframework/com/sym/ccm/adc/EgovCcmAdministCodePopup"
	 * @throws Exception
	 */
     ...
     * @param searchVO
     * @param model
     * @return "egovframework/example/egovframework/com/sym/ccm/adc/EgovCcmAdministCode"
     * @throws Exception
     */
	 ...
	 * @param commandMap
	 * @param model
	 * @return "egovframework/example/egovframework/com/sym/ccm/adc/EgovCcmAdministCodeModify"
	 * @throws Exception
	 */
