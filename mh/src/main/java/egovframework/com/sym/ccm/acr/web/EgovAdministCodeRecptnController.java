...
public class EgovAdministCodeRecptnController {
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "egovframework/example/egovframework/com/sym/ccm/adc/EgovCcmAdministCodeRegist"
	 * @throws Exception
	 */
	...
	public String insertAdministCodeRecptn (AdministCodeRecptn administCodeRecptn
    	...
    	if   (sCmd.equals("")) {
    		...
    		return "egovframework/example/egovframework/com/sym/ccm/acr/EgovAdministCodeRegist_TEST";
    	} else {
	 ...
	 * @param administCode
	 * @param model
	 * @return "egovframework/example/egovframework/com/sym/ccm/adc/EgovCcmAdministCodeDetail"
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/ccm/acr/getAdministCodeDetail.do")
 	public String selectAdministCodeDetail (@ModelAttribute("administCode") AdministCodeRecptn administCode
		...
		return "egovframework/example/egovframework/com/sym/ccm/acr/EgovAdministCodeDetail";
	}
     ...
     * @param searchVO
     * @param model
     * @return "egovframework/example/egovframework/com/sym/ccm/adc/EgovCcmAdministCodeList"
     * @throws Exception
     */
	...
	public String selectAdministCodeRecptnList (@ModelAttribute("searchVO") AdministCodeRecptnVO searchVO
        ...
        return "egovframework/example/egovframework/com/sym/ccm/acr/EgovAdministCodeRecptnList";
	}
	...
	public String selectAdministCodeRecptnMainList (@ModelAttribute("searchVO") AdministCodeRecptnVO searchVO
        ...
        return "egovframework/example/egovframework/com/sym/ccm/acr/EgovAdministCodeRecptnMainList";
	}
