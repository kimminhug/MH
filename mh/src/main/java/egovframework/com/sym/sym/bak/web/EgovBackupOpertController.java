...
public class EgovBackupOpertController {
	  ...
	  throws Exception{
		...
		backupOpertValidator.validate(backupOpert, bindingResult);
	  	if (bindingResult.hasErrors()){
	  		referenceData(model);
	  		return "egovframework/example/egovframework/com/sym/sym/bak/EgovBackupOpertRegist";
			}else{
	...
	public String selectBackupOpert(@ModelAttribute("searchVO")BackupOpert backupOpert, ModelMap model)
	  throws Exception{
		...
		return "egovframework/example/egovframework/com/sym/sym/bak/EgovBackupOpertDetail";
	}
	...
	public String selectBackupOpertForUpdate(@ModelAttribute("searchVO")BackupOpert backupOpert, ModelMap model)
	  throws Exception{
        ...
        return "egovframework/example/egovframework/com/sym/sym/bak/EgovBackupOpertUpdt";
	}
	...
	public String selectBackupOpertList(@ModelAttribute("searchVO")BackupOpert searchVO, ModelMap model)
	  throws Exception{
		...
		return "egovframework/example/egovframework/com/sym/sym/bak/EgovBackupOpertList";
	}
