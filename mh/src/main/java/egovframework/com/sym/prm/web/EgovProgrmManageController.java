...
public class EgovProgrmManageController {
    ...
    public String selectProgrm(
        ...
        return "egovframework/example/egovframework/com/sym/prm/EgovProgramListDetailSelectUpdt";
    }
    ...
    public String selectProgrmList(
        ...
        model.addAttribute("paginationInfo", paginationInfo);
      	...
      	return "egovframework/example/egovframework/com/sym/prm/EgovProgramListManage";
    ...
    public String selectProgrmChangeRequstList(
        ...
        model.addAttribute("paginationInfo", paginationInfo);
         ...
         return "egovframework/example/egovframework/com/sym/prm/EgovProgramChangeRequst";
    }
    ...
    public String selectProgrmChangeRequst(
         ...
         return "egovframework/example/egovframework/com/sym/prm/EgovProgramChangRequstDetailSelectUpdt";
    }
    ...
    public String updateProgrmChangeRequst(
		...
		if(progrmManageDtlVO.getRqesterPersonId() != null) {
    ...
    public String selectProgrmChangeRequstProcessList(
         ...
         return "egovframework/example/egovframework/com/sym/prm/EgovProgramChangeRequstProcess";
    }
    ...
    public String selectProgrmChangRequstProcess(
         ...
         model.addAttribute("progrmManageDtlVO", resultVO);
         return "egovframework/example/egovframework/com/sym/prm/EgovProgramChangRequstProcessDetailSelectUpdt";
    }
    ...
    public String selectProgrmChgHstList(
         ...
         return "egovframework/example/egovframework/com/sym/prm/EgovProgramChgHst";
    }
    ...
    public String selectProgramChgHstListDetail(
         ...
         return "egovframework/example/egovframework/com/sym/prm/EgovProgramChgHstDetail";
    }
    ...
    public String selectProgrmListSearch(
        ...
        model.addAttribute("paginationInfo", paginationInfo);
      	...
      	return "egovframework/example/egovframework/com/sym/prm/EgovFileNmSearch";
