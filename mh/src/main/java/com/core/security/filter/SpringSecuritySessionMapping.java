...
public class SpringSecuritySessionMapping extends EgovUsersByUsernameMapping {
	 ...
	 */
	public SpringSecuritySessionMapping(DataSource ds, String usersByUsernameQuery) {
