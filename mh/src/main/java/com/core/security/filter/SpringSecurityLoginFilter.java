...
import com.core.security.EgovUserDetailsHelper;
import com.mh.login.service.LoginService;
...
System.out.println("loginProcessURL :::::: " + loginProcessURL + " :::::: " +requestURL.contains(loginProcessURL));
System.out.println("isRemotelyAuthenticated :::::: " + isRemotelyAuthenticated);
			if (isRemotelyAuthenticated != null && isRemotelyAuthenticated.equals("true")) {
				...
				System.out.println("loginProcessURLloginProcessURLloginProcessURLloginProcessURLloginProcessURL ::::::: " + requestURL.contains(loginProcessURL));
