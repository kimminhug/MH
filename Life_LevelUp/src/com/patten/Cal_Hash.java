...
public class Cal_Hash {
	public void Set_Hash (Member_DTO dto) throws NoSuchAlgorithmException{
        ...
        dto.setSalt(salt);
        dto.setHash(hash);		// 생성된 소금과 해쉬를 사용자 정보 테이블에 저장
    }
	
	public boolean Test_Hash (Member_DTO dto, String test_hash) {
		String hash = dto.getHash();
		test_hash = test_hash + dto.getSalt();
